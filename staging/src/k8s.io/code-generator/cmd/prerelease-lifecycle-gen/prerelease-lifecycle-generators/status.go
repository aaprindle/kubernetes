...
func (g *genPreleaseLifecycle) argsFromType(c *generator.Context, t *types.Type) (generator.Args, error) {
	...
	// Use heuristic to determine whether the package is beta or GA.
	// Beta versions auto-generate deprecation/removal lifecycle metadata.
	// Alpha and GA versions require explicit lifecycle tags.
